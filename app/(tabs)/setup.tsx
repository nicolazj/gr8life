    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      <SignedOut>
        <View style={styles.unauthContainer}>
          <Text style={styles.unauthText}>Sign in to access settings</Text>
          <TouchableOpacity
          ...
          <View style={styles.card}>
            <TouchableOpacity style={styles.row}>
              ...
              <View style={styles.rowContent}>
                ...
                <Text style={styles.rowSubtitle}>Identity and contact data</Text>
              </View>
            ...
            <TouchableOpacity style={styles.row}>
              ...
              <View style={styles.rowContent}>
                ...
                <Text style={styles.rowSubtitle}>Alerts, sounds, and badges</Text>
              </View>
              <IconSymbol size={20} name="chevron.right" color="#ccc" />
            </TouchableOpacity>
